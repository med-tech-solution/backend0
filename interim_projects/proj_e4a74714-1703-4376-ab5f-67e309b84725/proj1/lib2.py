import logging
logging.basicConfig(filename='../function_logs/proj_e4a74714-1703-4376-ab5f-67e309b84725.log', level=logging.INFO, format='%(asctime)s - %(message)s', datefmt='%Y-%m-%d %H:%M:%S')
import numpy as np
