import logging
logging.basicConfig(filename='../function_logs/proj_9e38f340-40dc-4d38-be86-57013e46c6e7.log', level=logging.INFO, format='%(asctime)s - %(message)s', datefmt='%Y-%m-%d %H:%M:%S')
import numpy as np
